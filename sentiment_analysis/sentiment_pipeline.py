...
def sentiment_analysis(input_csv: str, analysis_type: str):
    ...
    irteera_fitxategia_decoded = f"emaitzak/emaitzak_sentiment_v2_SysPromptMotzaEus/{analysis_type}/{partition}/decoded/{IRTEERA_FITXATEGIA}"
    irteera_fitxategia_metrics = f"emaitzak/emaitzak_sentiment_v2_SysPromptMotzaEus/{analysis_type}/{partition}/metrics/{IRTEERA_FITXATEGIA}"
    irteera_fitxategia_confusion = f"emaitzak/emaitzak_sentiment_v2_SysPromptMotzaEus/{analysis_type}/{partition}/confusion_matrixes/{IRTEERA_FITXATEGIA.replace('.csv','')}"
